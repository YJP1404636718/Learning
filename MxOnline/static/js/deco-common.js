...
function search_click(){
    ...
    if(type == "course"){
        request_url = "/course/searchlist?keywords="+keywords
...
$(function() {
    ...
    $('.listoptions').find('.mores').click(function(){
        var height = $('.listoptions .conts').height();
        if(!$('.listoptions .conts').hasClass("opened")){
            $('.listoptions .conts').css({
                "height":"auto",
                "overflow":"visible"
            }).addClass("opened");
            $('.listoptions').find('.mores').html('收起')
        }else{
            ...
            $('.listoptions').find('.mores').html('更多')
        }
    });
