...
class UserProfile(AbstractUser):
    ...
    # mobile = models.IntegerField(max_length=11, null=True, blank=True, verbose_name=u"手机")
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(verbose_name="验证码类型", choices=(("register", u"注册"), ("forget", u"找回密码"), ("update_email", u"修改密码")), max_length=20)
